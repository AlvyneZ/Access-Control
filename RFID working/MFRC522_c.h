...
MFRC522_StatusCode MFRC522_PCD_CalculateCRC(	uint8_t *data,		///< In: Pointer to the data to transfer to the FIFO for CRC calculation.
	...
	// Wait for the CRC calculation to complete. Each iteration of the while-loop takes 17.73μs for Arduino Uno 16bit => needs i = 5000.
	// TODO check/modify for other architectures than Arduino Uno 16bit
	// For ATmega32a @internal 8MHz each loop takes (assumed) 21.95us => needs i = 4055
...
MFRC522_StatusCode MFRC522_PCD_CommunicateWithPICC(	uint8_t command,		///< The command to execute. One of the PCD_Command enums.
	...
	// Each iteration of the do-while-loop takes 17.86μs for Arduino Uno 16bit @ 16MHz. => needs i = 2000
	// TODO check/modify for other architectures than Arduino Uno 16bit
	// For ATmega32a @internal 8MHz each loop takes 22.016us => needs i = 1622
	uint16_t i;
	for (i = 1622; i > 0; i--) {
